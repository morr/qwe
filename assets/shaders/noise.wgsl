...
//
// Третий потребитель — полог кроны (`crown.wgsl`): ему нужен ровно `fbm3`, той
// же рябью и с тем же гашением по пикселю, что у поверхностей и кровель.
//
// Портал (`portal.wgsl`) остаётся при своих
