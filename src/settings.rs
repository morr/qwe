...
// --- Спасение застрявших ---
/// Период скана «кто стоит в непроходимом», в фиксированных шагах. Один скан —
/// это проход по всем ~20 000 движимых сущностей, а на 30x шагов 1800 в
/// реальную секунду: скан на каждом шаге стоил бы больше, чем само движение.
/// Раз в виртуальную секунду застрявший ждёт спасения не дольше секунды — а
/// попадает он туда единицами и редко.
pub const RESCUE_SCAN_STEPS: u32 = 60;
