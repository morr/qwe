...
/// поверх парковой заливки, иначе газон сливается с лесом. Им же засеяна
/// разделительная парных половин (`roads/medians.rs`).
pub(crate) const GRASS_COLOR: Color = Color::srgb(0.867, 0.937, 0.745);
