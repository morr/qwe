...
/// прижать результат к карте. Отличаются они только числами — у человека
/// ±60° и 20–40 м, у демона ±1.3 рад (≈±75°) и 40–120 м.
///
...
/// следующего решения.
///
/// Зовут её три места: прогулка обоих видов и перепрокладка погони
/// (`demon/behavior.rs`). Последний рукописный экземпляр этого хвоста остался
/// в перепрокладке бегства (`human/behavior.rs`).
