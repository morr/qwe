...
//! протяжка стоит куда дороже соседних секций: шаг у них крупный, а сама
//! пересборка ждёт, пока ползунок отпустят (`map::sun::settle_sun`). Знать об
//! этом секции не надо: ручки пишут `SunStyle`, как всякие другие, а оседание
//! сидит между ним и картой.
