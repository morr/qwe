...
use crate::map::osm::model::{
    AreaKind, MapData, PolyArea, RailLine, RoadLine, TrafficSide, TreeCompose, TreeNode, TreeRow,
...
use self::tags::{
    ...
    road_class, row_spacing, service_track, tagged_lanes, water_class, water_width,
};
