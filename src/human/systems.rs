...
/// списка входов, именно поэтому: размеченных в OSM входов на город сотни
/// (Тула — 491 на 7723 дома), и адресуйся пешки прямо к ним, двадцать тысяч
/// человек ходили бы по одним и тем же дверям.
