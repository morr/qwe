...
/// сейчас «31% tagged, median 8 m, p90 15 m, max 82 m» — распределение с
/// формой; «median 15, p90 15» это прежние картонные коробки, а «p90 27» —
/// первая, небоскрёбная версия таблицы башен (см. [`TOWER_STOREYS`]).
