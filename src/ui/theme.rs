...
/// яркость текста ([`MUTED_TEXT`]) — иначе плашку пришлось бы делать глухой,
...
const MUTED_TEXT: Color = Color::oklcha(0.90, 0.0015, 286.3, 1.0);
...
fn create_panel_theme() -> ThemeProps {
    ...
    props.color.insert(tokens::TEXT_DIM, MUTED_TEXT);
