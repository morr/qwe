...
/// Цвет тени — не серый, а холодный синий: в тень на снимке светит небо, и
/// именно поэтому тень фотографии синеет, а не сереет. Общий и для домов, и
/// для крон по той же причине, что и [`SHADOW_DIR`].
pub const SHADOW_COLOR: Color = Color::srgba(0.14, 0.17, 0.26, 0.46);
