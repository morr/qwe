...
//! заполнения описанного прямоугольника и допустимый вылет его угла, доли
//! форм (вальмы, слуховых окон), числа полувальмы, ломаной и односкатной,
//! вылет ската вальмы и его зажим, уклон. Витрина печатает их рядом с
//! картинкой — иначе «на этой кровле заплат больше» и «эта вальма скорее
//! фаска» не с чем сопоставить, и подобрать константу по виду нельзя, не
