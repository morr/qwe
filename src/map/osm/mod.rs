...
pub use self::model::{
    AreaKind, BuildingUse, Faith, FenceKind, FenceLine, MapData, PipeLine, PitchKind, PolyArea,
    RailKind, RailLine, RoadClass, RoadLine, RowTrees, Sacred, SacredForm, ServiceTrack, Structure,
