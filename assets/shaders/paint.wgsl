...
struct Vertex {
    ...
    // пунктиром и сплошной подхода). У поперечной краски (3–5) «длина» идёт
...
fn fragment(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    if kind == 7u {
        ...
        // у линии полос открытой улицы сплошной кусок отмерен по ходу её
        // полос (10 — пунктир, 11 — подход к узлу); у осевой и на кольце —
        // по близости разрыва
